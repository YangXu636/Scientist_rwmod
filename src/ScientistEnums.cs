...
namespace Scientist.ScientistEnums
{
    ...
    public static class Action_Fp
    {
        ...
        public static SSOracleBehavior.Action MeetScientist_ThrowOut;
        ...
        public static void RegisterValues()
        {
            ...
            MeetScientist_ThrowOut = new SSOracleBehavior.Action("MeetScientist_ThrowOut", true);
        }
        ...
        public static void UnregisterValues()
        {
            ...
            SSOracleBehavior.Action meetScientist_ThrowOut = MeetScientist_ThrowOut;
            meetScientist_ThrowOut?.Unregister();
            MeetScientist_ThrowOut = null;
        }
    }
