...
class BlastingStoneBomb : Weapon, IProvideWarmth
{
    ...
    public BlastingStoneBomb(AbstractPhysicalObject abstractPhysicalObject, World world) : base(abstractPhysicalObject, world)
    {
